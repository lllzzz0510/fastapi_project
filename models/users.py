...
from sqlalchemy import Index, Integer, String, DateTime, Enum, ForeignKey
...
class User(Base):
    ...
    bio: Mapped[Optional[str]] = mapped_column(String(500), comment='个人介绍', default='这个人很懒，什么都没留下')
